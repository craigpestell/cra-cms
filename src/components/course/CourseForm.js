...
export const CourseForm = ({
  ...
  return (
    <form onSubmit={handleSubmit(handleSave)}>
      ...
      <Field type="text" name="title" label="Title" placeholder="Title of the course" component={FieldInput} />

      <Field name="authorId" label="Author" options={authors} component={SelectInput} />

      <Field type="text" name="category" label="Category" placeholder="Category of the course" component={FieldInput} />
